...
const PostDetailPage: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto p-6 pt-12 font-[Pretendard]">
      <div className="flex items-center gap-4 mb-6">
        <div className="w-[80px] h-[80px] rounded-full bg-[#D9D9D9] opacity-80" />
        <div className="flex items-center gap-1">
          <img src={bestBadge} alt="best badge" className="w-5 h-5" />
          <span className="text-gray-800 font-medium text-base">닉네임</span>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-[60px]">
        <div
          className="bg-[#D9D9D9] rounded-[32px] flex-shrink-0"
          style={{ width: "50%", height: "681.76px" }}
        ></div>
        ...
        <div className="flex flex-col gap-6 text-left flex-1">
          ...
          <p className="text-gray-700 text-[16px] font-medium leading-relaxed">
            ...
            밀폐용기입니다.
            <br />
            BPA Free 재질로 인체에 유해한 환경호르몬이 검출되지 않아 안심하고
            사용할 수 있으며, 전자레인지 및 식기세척기 사용도 가능합니다.
          </p>

          <div className="flex gap-[40px] border border-[#E6E6E6] rounded-[32px] p-[24px] text-[16px] leading-[24px] w-full">
            <div className="flex flex-col gap-[8px] w-full">
              <table className="w-full text-left">
                <tbody>
                  <tr className="align-top">
                    <td className="w-[95px] font-bold">주요 특징</td>
                    <td>
          ...
          <div className="flex gap-[40px] border border-[#E6E6E6] rounded-[32px] p-[24px] text-[16px] mt-6 font-medium w-full">
            <div className="flex flex-col gap-[8px] w-full">
              <table className="w-full text-left">
                <tbody>
                  <tr className="align-top">
                    <td className="w-[95px] font-bold">추천 대상</td>
                    <td>
                      <div className="flex mb-[8px]">
                        <div className="font-medium text-gray-700">
                          냉장고 정리를 효율적으로 하고싶은 분
                        </div>
                      </div>
                      <div className="flex mb-[8px]">
                        <div className="font-medium text-gray-700">
                      ...
                      <div className="flex mb-[8px]">
                        <div className="font-medium text-gray-700">
                          정리도구를 통해 생활의 편리함을 높이고 싶은 자취생 및
                          1인 가구
                        </div>
                      </div>
                    </td>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-2 mt-4 flex-wrap">
              {["#해시태그", "#해시태그", "#해시태그", "#해시태그"].map(
                (tag, idx) => (
                  <span
                    key={idx}
                    className="flex items-center justify-center bg-[#CCE5FF] text-[#000] text-sm rounded-[32px] px-3 py-1"
                  >
                    {tag}
                  </span>
                )
            ...
            <div className="flex justify-between items-center mt-4">
              <button
                className="flex items-center gap-2 bg-[#0080FF] text-white text-[20px] font-medium rounded-[32px] px-8 py-3"
                style={{ width: "156px", height: "54px" }}
              >
                <img src={heartIcon} alt="like" className="w-5 h-5" /> 좋아요
              </button>
              <button
          ...
          {sortedComments.map((comment) => (
            <div key={comment.id} className="flex flex-col gap-2">
              <div className="flex justify-between">
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    ...
                    <div className="text-[16px] mt-1">{comment.content}</div>
              ...
              {comment.replies.map((reply) => (
                <div
                  key={reply.id}
                  className="flex gap-5 items-center ml-12 mt-5"
                >
                  <div className="w-[40px] h-[40px] rounded-full bg-[#D9D9D9]" />
                  <div>
                    <div className="text-[20px] font-medium">
                    ...
                    <div className="text-[16px] mt-1">{reply.content}</div>
                    <div className="flex items-center gap-4 mt-1 text-sm text-[#999]">
                      <span>14시간 전</span>
                      <div className="flex items-center gap-1">
                        <img src={likesIcon} alt="likes" className="w-4 h-4" />{" "}
